...
export default function Hero() {
  ...
  // Hero image — static until alarm card is in the upper third (P=0.72), then
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── House photo — scrolls up at 2000px/unit starting at P=0.60 ──── */}
        <motion.div
          aria-hidden="true"
          style={{
            position: "absolute",
        ...
        >
          ...
          >
            ...
            {/* Thermal house image — mouse parallax + scrolls with imageY in sync with house-normal */}
            <motion.div
              style={{
                position: "absolute",
                right:    0,
